...
const getSticky = () => {
    document.querySelectorAll("[data-jsticky]").forEach((sticky: HTMLElement, i) => {
...
const getScroll = () => {
    document.querySelectorAll("[data-jscroll='true']").forEach((scroll: HTMLElement) => {
...
const getTrigger = () => {
    document.querySelectorAll("[data-jtrigger]").forEach((trigger: HTMLElement) => {
